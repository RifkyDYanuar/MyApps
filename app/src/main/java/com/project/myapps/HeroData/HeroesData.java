...
public class HeroesData {
    ...
    private static String[] heroesDetail = {
            ...
            "Tan Malaka, seorang tokoh revolusi Indonesia yang dikenal sebagai intelektual, pemimpin politik, dan pahlawan kemerdekaan."
    };
    ...
    public  static  ArrayList<HeroClass>getListData(){
        ArrayList<HeroClass> list=new ArrayList<>();
